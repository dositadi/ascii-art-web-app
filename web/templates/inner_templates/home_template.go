...
func HomePageTemplate(w http.ResponseWriter) *m.Error {
	...
	homePageDetails := struct {
      ...
      transforming your words into stunning block art with a single click.
		...
		LeadContributorName: "Ositadinma Divine .A.", Contributor2Name: "Julius Adenuga", Contributor3Name: "Desmond Eliot",
		...
		Contributor2About: `Julius led the visual identity of ASCIIForge — from the milk-and-blue palette
              to the monospace-driven component language. He drew the wireframes, iterated
              the card layouts, and obsessed over every 0.5px border and spacing token
              until the UI felt truly native to the terminal world. He's passionate about
              design systems and the intersection of print typography and web UI.`,
		Contributor3About: `Desmond is a full-stack developer with a deep love for the terminal aesthetic.
